...
def remove_item():
    banish = input("What Item would you like to remove from the frocery list ")
# If the item exists, remove it
    if banish in grocery_list:
         grocery_list.remove(banish)
...
# (1) Add an item
    if user_input == "add item":
        add_item()
        print("This is you update grocery list")
        show_list()
# (2) Remove an item
